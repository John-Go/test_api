...
class Pension_model extends CI_Model {
    ...
    public function randomBannerList($data){
        ...
        $schQuery = "   SELECT PS.mpsIdx,PS.mpIdx,PS.mpsName,PS.mpsAddr1,PS.mpsAddrSi,PS.mpsAddrGun,MTB.arbFilename,MTB.arbTitle, MTB.arbWidth, MTB.arbHeight, PPB.ppbWantCnt, MTB.arbTag,
                        CASE WHEN peIdx THEN
                            CASE peDay
                                WHEN '1' THEN MAX(ppdpPercent1)
                                WHEN '5' THEN MAX(ppdpPercent5)
                        ...
                        LEFT JOIN pensionDB.pensionPrice AS PP ON PP.mpIdx = MTB.mpIdx AND '".date('Y-m-d')."' BETWEEN ppdpStart AND ppdpEnd
        ...
        $this->db->select('PS.mpsIdx,PS.mpIdx,PS.mpsName,PS.mpsAddr1,PS.mpsAddrSi,PS.mpsAddrGun,MTB.arbFilename,MTB.arbTitle');
